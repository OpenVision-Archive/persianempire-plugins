...
class PackageManagerScreen(Screen):
	...
	<widget source = "key_red" render="Label" position="20,358" zPosition="2" size="170,30" verticalAlignment="center" horizontalAlignment="center" font="Regular;22" transparent="1" />
	<widget source = "key_green" render="Label" position="190,358" zPosition="2" size="230,30" verticalAlignment="center" horizontalAlignment="center" font="Regular;22" transparent="1" />
	<widget source = "key_yellow" render="Label" position="420,358" zPosition="2" size="170,30" verticalAlignment="center" horizontalAlignment="center" font="Regular;22" transparent="1" />
...
<widget source="menu" render="Listbox" position="15,10" size="720,300" scrollbarMode="showOnDemand">
	...
	<widget source="key_green" render="Label" position="190,328" zPosition="2" size="170,30" verticalAlignment="center" horizontalAlignment="center" font="Regular;22" transparent="1" />
	<ePixmap position="360,358" zPosition="1" size="200,2" pixmap="~/images/yellow.png" transparent="1" alphaTest="on" />
	<widget source="key_yellow" render="Label" position="360,328" zPosition="2" size="200,30" verticalAlignment="center" horizontalAlignment="center" font="Regular;22" transparent="1" />
</screen>"""
