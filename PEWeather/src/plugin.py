...
def Plugins(path, **kwargs):
    global pluginpath
    pluginpath = path
    return PluginDescriptor(name='PE Weather', description='Special Version For Persian Empire', where=PluginDescriptor.WHERE_PLUGINMENU, fnc=main, icon='peweather.png')
