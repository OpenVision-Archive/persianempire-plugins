...
class ProgressDiskSpaceInfo(Poll, Converter):
	...
	def __init__(self, type):
		...
		if self.type in (self.FLASHINFO,self.HDDINFO,self.USBINFO,self.CFINFO):
	...
	def getText(self):
		...
		if self.type == self.HDDTEMP:
			...
			entry = {
					...
					self.CFINFO:	("/media/cf","CF"),
					self.HDDINFO:   ("/media/hdd","HDD"),
					self.FLASHINFO: ("/","Flash"),
				}[self.type]
			if self.type in (self.USBINFO,self.CFINFO,self.HDDINFO,self.FLASHINFO):
	...
	def getValue(self):
		...
		elif self.type in (self.USBINFO,self.CFINFO,self.HDDINFO,self.FLASHINFO):
			path = {self.USBINFO: "/media/usb", self.CFINFO: "/media/cf", self.HDDINFO: "/media/hdd", self.FLASHINFO: "/"}[self.type]
