...
class ShowPurePrestigeSetup(Screen, ConfigListScreen):
    skin = '\n       \t<screen name="ShowPurePrestigeSetup" position="center,center" size="640,520" title=""  flags="wfNoBorder" >\n                <ePixmap pixmap="~/images/framesd.png" position="0,0" size="640,520"/>\n\t\t\n\t        <ePixmap name="red"  position="195,450" zPosition="2" size="150,30" pixmap="~/ddbuttons/red.png" transparent="1" alphaTest="on" />\n\t        <ePixmap name="green" position="321,450" zPosition="2" size="150,30" pixmap="~/ddbuttons/green.png" transparent="1" alphaTest="on" /> \n        \t\n\n        \t\n        \t<widget name="key_red" position="182,457" size="150,45" verticalAlignment="center" horizontalAlignment="center" zPosition="4"  foregroundColor="white" font="Regular;20" transparent="1" shadowColor="#25062748" shadowOffset="-2,-2" /> \n                <widget name="key_green" position="312,457" size="150,45" verticalAlignment="center" horizontalAlignment="center" zPosition="4"  foregroundColor="white" font="Regular;18" transparent="1" shadowColor="#25062748" shadowOffset="-2,-2" />\n        \t\t\t\n                        <widget name="config" position="15,50" size="610,320" scrollbarMode="showOnDemand" transparent="1" zPosition="2" />\n\t\t        <widget name="info" position="0,370" zPosition="4" size="400,30" font="Regular;20" foregroundColor="yellow" transparent="1" horizontalAlignment="left" verticalAlignment="center" />\n                </screen>'
