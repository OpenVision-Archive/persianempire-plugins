...
class persianFavoritescrn(Screen):
    ...
    if HD_Res:
        skin = '\n                <screen  position="center,center" size="920,600" title=""  flags="wfNoBorder" >\n                <ePixmap pixmap="~/images/frame.png" position="0,0" size="920,600" transparent="1"/>\t\n                        <ePixmap alphaTest="on" name="red" pixmap="~/Applications//NetRadioPersian/buttons/red.png" position="15,30" size="200,40" transparent="1" zPosition="4"/>\n\t\t\t<ePixmap alphaTest="on" name="green" pixmap="~/Applications//NetRadioPersian/buttons/green.png" position="215,30" size="200,40" transparent="1" zPosition="4"/>\n\t\t\t<ePixmap alphaTest="on" name="yellow" pixmap="~/Applications//NetRadioPersian/buttons/yellow.png" position="415,30" size="200,40" transparent="1" zPosition="4"/>\n\t\t\t<ePixmap alphaTest="on" name="blue" pixmap="~/Applications//NetRadioPersian/buttons/blue.png" position="615,30" size="215,30" transparent="1" zPosition="4"/>\n\t\t\t<widget font="Regular;21" foregroundColor="white" horizontalAlignment="center" name="key_red" position="15,30" shadowColor="black" shadowOffset="-1,-1" size="150,40" transparent="1" verticalAlignment="center" zPosition="5"/>\n\t\t\t<widget font="Regular;21" foregroundColor="white" horizontalAlignment="center" name="key_green" position="215,30" shadowColor="black" shadowOffset="-1,-1" size="150,40" transparent="1" verticalAlignment="center" zPosition="5"/>\n\t\t\t<widget font="Regular;21" foregroundColor="white" horizontalAlignment="center" name="key_yellow" position="415,30" shadowColor="black" shadowOffset="-1,-1" size="150,40" transparent="1" verticalAlignment="center" zPosition="5"/>\n\t\t\t<widget font="Regular;21" foregroundColor="white" horizontalAlignment="center" name="key_blue" position="615,30" shadowColor="black" shadowOffset="-1,-1" size="150,40" transparent="1" verticalAlignment="center" zPosition="5"/>\n                        <ePixmap position="15,700" size="890,5" pixmap="~/Applications/NetRadioPersian/icons/slider.png" alphaTest="blend" transparent="1" backgroundColor="transparent"/>\n\t\t\t<widget name="favoritemenu" position="15,80" size="890,520"  itemHeight="40" scrollbarMode="showOnDemand" transparent="1" zPosition="4" />\n\t\t\t\n\t\t</screen>'
    else:
        skin = '\n                    <screen  position="center,center" size="580,450" title=""  flags="wfNoBorder" >\n                <ePixmap pixmap="~/images/framesd.png" position="0,0" size="640,520"/>\t\n\t\t        \n            <ePixmap name="red" position="10,15" zPosition="4" size="150,40" pixmap="~/Applications//NetRadioPersian/buttons/red.png" transparent="1" alphaTest="on" />\n\n                        <ePixmap name="green" position="160,15" zPosition="4" size="150,40" pixmap="~/Applications//NetRadioPersian/buttons/green.png" transparent="1" alphaTest="on" />\n\t\t\t<ePixmap name="yellow" position="310,15" zPosition="4" size="150,40" pixmap="~/Applications//NetRadioPersian/buttons/yellow.png" transparent="1" alphaTest="on" />\n\t\t\t<ePixmap name="blue" position="460,15" zPosition="4" size="150,40" pixmap="~/Applications//NetRadioPersian/buttons/blue.png" transparent="1" alphaTest="on" />\n\t\t\t<widget name="key_red" position="10,15" zPosition="5" size="150,40" verticalAlignment="center" horizontalAlignment="center" font="Regular;21" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />\n\t\t\t<widget name="key_green" position="160,15" zPosition="5" size="150,40" verticalAlignment="center" horizontalAlignment="center" font="Regular;21" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />\n\t\t\t<widget name="key_yellow" position="310,15" zPosition="5" size="150,40" verticalAlignment="center" horizontalAlignment="center" font="Regular;21" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />\n\t\t\t<widget name="key_blue" position="460,15" zPosition="5" size="150,40" verticalAlignment="center" horizontalAlignment="center" font="Regular;21" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />\n\t\t\t<widget name="favoritemenu" position="20,50" size="600,400" scrollbarMode="showOnDemand" transparent="1" zPosition="4" />\n\t\t\t\n\t\t        \n                </screen>'
...
class persianStationsScreen(Screen):
    ...
    if HD_Res:
        skin = '\n\t\t<screen position="center,center" size="920,600" title="Persian Radio" flags="wfNoBorder" >\n\t\t\t  <ePixmap pixmap="~/images/frame.png" position="0,0" size="920,600" transparent="1"/>\t\n                          <widget name="info" position="20,0" size="800,40" verticalAlignment="center" horizontalAlignment="center" zPosition="10" font="Regular;20" transparent="1" foregroundColor="yellow"  />\n                          <widget name="ButtonYellowtext" position="20,0" size="100,60" verticalAlignment="center" horizontalAlignment="center" zPosition="10" font="Regular;20" transparent="1"  />\t\t\t  \n                          <widget name="ButtonYellow" pixmap="~/Applications/NetRadioPersian/buttons/yellow.png" position="20,10" zPosition="10" size="100,60" transparent="1" alphaTest="on" />\n                          <widget name="stationmenu" position="15,60" size="890,520"  itemHeight="40" scrollbarMode="showOnDemand" transparent="1" zPosition="4" />\n                          <ePixmap position="15,50" size="890,5" pixmap="~/Applications/NetRadioPersian/icons/slider.png" alphaTest="blend" transparent="1" backgroundColor="transparent"/>\t                  \n        \t</screen>\n\t\t'
    else:
        skin = '\n\t\t<screen position="center,center" size="600,500" title="Persian Radio" >\n\n                          <widget name="info" position="20,0" size="600,40" verticalAlignment="center" horizontalAlignment="center" zPosition="10" font="Regular;20" transparent="1" foregroundColor="yellow"  />\n                          \n                          <widget name="ButtonYellowtext" position="20,10" size="100,40" verticalAlignment="center" horizontalAlignment="center" zPosition="10" font="Regular;20" transparent="1"  />\n\t\t\t  <widget name="ButtonYellow" pixmap="~/Applications/NetRadioPersian/buttons/yellow.png" position="20,10" zPosition="10" size="100,60" transparent="1" alphaTest="on" />\n                          <widget name="stationmenu" position="10,40" size="590,425" scrollbarMode="showOnDemand" transparent="1" zPosition="4" />\n\t                  \n        \t</screen>\n\t\t'
