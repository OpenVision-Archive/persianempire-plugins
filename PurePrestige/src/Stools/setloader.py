...
class PurePrestigeSL_Setup(Screen, ConfigListScreen):
    skin = '\n                               <screen  position="center,center" size="640,520" title=""  flags="wfNoBorder" >\n                                <ePixmap pixmap="~/images/framesd.png" position="0,0" size="640,520" transparent="1"/>\t\n                        <widget name="config" position="15,30" size="610,300" scrollbarMode="showOnDemand" zPosition="2" transparent="1"  />\n\n\t\t\t                               <ePixmap position="15,365" size="610,5" pixmap="~/images/slider.png" alphaTest="blend" transparent="1" backgroundColor="transparent"/>\n\t\t\t<widget name="key_green" position="120,420" size="140,40" verticalAlignment="center" horizontalAlignment="center" zPosition="5" transparent="1" foregroundColor="white" font="Regular;18"/>\n\t\t\t<widget name="key_yellow" position="260,420" size="140,40" verticalAlignment="center" horizontalAlignment="center" zPosition="5" transparent="1" foregroundColor="white" font="Regular;18"/>\n\t\t\t\n\t\t\t\n\t\t\t\n\t\t\t<ePixmap name="green" pixmap="~/ddbuttons/green.png" position="120,415" size="140,40" zPosition="4" transparent="1" alphaTest="on"/>\n\t\t\t<ePixmap name="yellow" pixmap="~/ddbuttons/yellow.png" position="260,415" size="140,40" zPosition="4" transparent="1" alphaTest="on"/>\n\t\t\t<widget name="key_blue" position="400,420" size="140,40" verticalAlignment="center" horizontalAlignment="center" zPosition="5" transparent="1" foregroundColor="white" font="Regular;18"/>\n\t\t\t\n\t\t\t\n\t\t\t\n\n\t\t\t<ePixmap name="blue" pixmap="~/ddbuttons/blue.png" position="400,415" size="140,40" zPosition="4" transparent="1" alphaTest="on"/>\n\t\t\t\t\t\t\n\t\t</screen>'
...
class PurePrestigeSL_ActionBox(Screen):
    skin = '\n\t\t<screen position="center,center" size="560,70" title=" ">\n\n                        <widget alphaTest="on" name="logo" position="10,10" size="48,48" transparent="1" zPosition="2" backgroundColor="background" />\n\t\t\t<widget font="Regular;20" horizontalAlignment="center" name="message" position="10,10" size="538,48" verticalAlignment="center" foregroundColor="foreground" backgroundColor="background" transparent="1" zPosition="2" />\n\t\t</screen>'
...
class PurePrestigeSL_KeepBouquets(Screen):
    skin = '\n                <screen  position="center,center" size="640,520" title=""  flags="wfNoBorder" >\n                <ePixmap pixmap="~/images/framesd.png" position="0,0" size="640,520" transparent="1"/>\t\n\n                <ePixmap position="15,460" size="610,5" pixmap="~/images/slider.png" alphaTest="blend" transparent="1" backgroundColor="transparent"/>\n                                <widget source="list" render="Listbox" position="20,15" size="600,440" scrollbarMode="showOnDemand" transparent="1" zPosition="2" >\n\t\t\t\t<convert type="TemplatedMultiContent">\n\t\t\t\t\t{"template": [\n\t\t\t\t\t\tMultiContentEntryText(pos = (70, 5), size = (360, 38), font=0, flags = RT_HALIGN_LEFT|RT_VALIGN_TOP, text = 1),\n\t\t\t\t\t\tMultiContentEntryText(pos = (430, 5), size = (150, 38), font=0, flags = RT_HALIGN_LEFT|RT_VALIGN_TOP, text = 2),\n\t\t\t\t\t\tMultiContentEntryPixmapAlphaTest(pos = (3, 3), size = (64, 64), png = 0), # Icon\n\n\t\t\t\t\t\t],\n\t\t\t\t\t\t"fonts": [gFont("Regular", 22)],\n\t\t\t\t\t\t"itemHeight": 40\n\t\t\t\t\t}\n\t\t\t\t</convert>\n\t\t\t</widget>\n\t\t\t\n\t\t\t\n\t\t\t\n\t\t\t<widget name="key_blue" position="210,475" size="140,40" verticalAlignment="center" horizontalAlignment="center" zPosition="5" transparent="1" foregroundColor="white" font="Regular;18"/>\n\t\t\t\n\t\t\t\n\t\t\t\n\t\t\t<ePixmap name="blue" pixmap="~/ddbuttons/blue.png" position="210,470" size="140,40" zPosition="4" transparent="1" alphaTest="on"/>\n\t\t\t\n\t\t</screen>'
    ...
    def buildListEntry(self, enabled, name, type):
        if enabled:
            pixmap = LoadPixmap(cached=True, path=resolveFilename(SCOPE_PLUGINS, '~/images/lock_on.png'))
        else:
            pixmap = LoadPixmap(cached=True, path=resolveFilename(SCOPE_PLUGINS, '~/images/lock_off.png'))
...
class PurePrestigesettingsserver(Screen):
    skin = '\n                               <screen  position="center,center" size="640,520" title=""  flags="wfNoBorder" >\n                                <ePixmap pixmap="~/images/framesd.png" position="0,0" size="640,520" transparent="1"/>\t\n\t\t\n                <ePixmap name="yellow" position="250,460" zPosition="4" size="180,40" pixmap="~/ddbuttons/yellow.png" transparent="1" alphaTest="on" />\n\t\t\t\n\t\t<widget name="key_yellow" position="230,465" zPosition="5" size="180,40" verticalAlignment="center" horizontalAlignment="center" font="Regular;21" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />\n    \n                <widget name="list" position="15,60" size="610,348" scrollbarMode="showOnDemand" transparent="1" zPosition="2" />\n                <ePixmap position="15,405" size="610,5" pixmap="~/images/slider.png" alphaTest="blend" transparent="1" backgroundColor="transparent"/>\t        \n        \n        </screen>'
