...
class PurePrestigeFeedScreenList(Screen):
    global HD_Res
    try:
    ...
    def showFeed(self, feed):
        try:
            self.session.open(PurePrestigeFeedScreenContent, feed)
        except IOError as e:
...
class FeedreaderConfig:
    configfile = '/etc/tspanelfeeds.xml'
...
class PurePrestigeFeedScreenContent(Screen):
    if HD_Res == True:
        skin = '\n        \t\n                <screen  position="center,center" size="920,600" title=""  flags="wfNoBorder" >\n                <ePixmap pixmap="~/images/frame.png" position="0,0" size="920,600" transparent="1"/>\t\n                <widget name="info" position="10,10" zPosition="4" size="560,55" font="Regular;20" foregroundColor="#ffffff" transparent="1" horizontalAlignment="center" verticalAlignment="center" />\n                <ePixmap position="15,65" size="890,5" pixmap="~/images/slider.png" alphaTest="blend" transparent="1" backgroundColor="transparent"/>\n                <widget name="mylist" position="20,80" size="880,490" scrollbarMode="showOnDemand" transparent="1" zPosition="2" />\n                 \n                        \n                \n                \n                </screen>'
    else:
        skin = '\n        \t\n         \n        \t\n                <screen  position="center,center" size="580,450" title=""  flags="wfNoBorder" >\n                <ePixmap pixmap="~/images/framesd.png" position="0,0" size="580,450" transparent="1"/>\t\n                <widget name="info" position="2,5" zPosition="4" size="580,30" font="Regular;20" foregroundColor="#ffffff" transparent="1" horizontalAlignment="center" verticalAlignment="center" />\n                <ePixmap position="15,35" size="550,5" pixmap="~/images/slider.png" alphaTest="blend" transparent="1" backgroundColor="transparent"/>\n                <widget name="mylist" position="10,40" size="560,390" scrollbarMode="showOnDemand" transparent="1" zPosition="2" />\n\n\t\t\n\n\n                \n                </screen>'
    ...
    def filllist(self):
        ...
        for item in self.getFeedContent(self.feed):
            ...
            if HD_Res == True:
                ...
                res.append(MultiContentEntryText(pos=(5, 5), size=(890, 30), font=0, flags=RT_HALIGN_CENTER, text=item['title'], color=16770229, color_sel=16770229))
            else:
                res.append(MultiContentEntryText(pos=(0, 5), size=(5, 30), font=0, flags=RT_HALIGN_CENTER, text='', color=16777215, color_sel=16777215))
    ...
    def go(self):
        ...
        if selection is not None:
            ...
            if item['type'].startswith('folder') is True:
                ...
                self.session.open(PurePrestigeFeedScreenContent, newitem)
            elif item['type'].startswith('pubfeed') is True:
                newitem = Feed(item['title'], item['desc'], item['link'])
                self.session.open(PurePrestigeFeedScreenContent, newitem)
            else:
                try:
                    self.session.open(PurePrestigeFeedScreenItemviewer, [self.feed,
                     item,
                     self.currentindex,
                     self.itemlist])
...
class PurePrestigeFeedScreenItemviewer(Screen):
    ...
    def __init__(self, session, args=0):
        ...
        if HD_Res == True:
            self.skin = '\n                <screen name="FMenusimple" position="center,center" size="920,600" title="%s"  flags="wfNoBorder" >\n                <ePixmap pixmap="~/images/frametop.png" position="0,0" size="920,600"/>\t\n                <ePixmap pixmap="~/images/frameleft.png" position="0,10" size="10,580"/>\t\n                <ePixmap pixmap="~/images/frameright.png" position="910,10" size="10,580"/>\t\n                <ePixmap pixmap="~/images/framebottom.png" position="0,590" size="920,10"/>\t\n\t\t\t\t        <widget name="titel" position="20,0" zPosition="1" size="560,130" font="Regular;24" transparent="1"  backgroundColor="#00000000" foregroundColor="yellow" verticalAlignment="center" horizontalAlignment="left" />\n\t\t\t\t        <widget name="leagueNumberWidget" position="830,60" size="90,30" transparent="1" horizontalAlignment="left" font="Regular;20" foregroundColor="yellow"/>\n                                        <ePixmap position="830,20" zPosition="4" size="60,40" pixmap="~/images/arrows.png" transparent="1" alphaTest="on" />\n\t\t\t\t        <ePixmap position="15,88" size="890,12" pixmap="~/images/slider.png" alphaTest="blend" transparent="1" backgroundColor="transparent"/>\n\t\t\t\t\t<widget name="text" position="20,100" size="880,400" font="Regular;22" />\n\t\t\t\t         <ePixmap position="15,510" size="890,5" pixmap="~/images/slider.png" alphaTest="blend" transparent="1" backgroundColor="transparent"/>\n                                        <ePixmap alphaTest="on" name="more" pixmap="~/buttons/more.png" position="400,530" size="120,50" transparent="1" zPosition="4"/>\n                                </screen>' % self.feed.getName()
        else:
            self.skin = '\n                <screen name="FMenusimple" position="center,center" size="580,450" title="%s"  flags="wfNoBorder" >\n                <ePixmap pixmap="~/images/frametop.png" position="0,0" size="580,450"/>\t\n                <ePixmap pixmap="~/images/frameleft.png" position="0,7" size="6,435"/>\t\n                <ePixmap pixmap="~/images/frameright.png" position="573,7" size="6,435"/>\t\n                <ePixmap pixmap="~/images/framebottom.png" position="0,442" size="580,7"/>\n\t\t\t\t        <widget name="titel" position="10,0" zPosition="1" size="490,130" font="Regular;24" transparent="1"  backgroundColor="#00000000" foregroundColor="yellow" verticalAlignment="center" horizontalAlignment="left" />\n\t\t\t\t        <widget name="leagueNumberWidget" position="520,60" size="70,30" transparent="1" horizontalAlignment="left" font="Regular;20" foregroundColor="yellow"/>\n                                        <ePixmap position="520,20" zPosition="4" size="60,40" pixmap="~/images/arrows.png" transparent="1" alphaTest="on" />\n\t\t\t\t        <ePixmap position="15,88" size="550,12" pixmap="~/images/slider.png" alphaTest="blend" transparent="1" backgroundColor="transparent"/>\n\t\t\t\t\t<widget name="text" position="10,100" size="560,300" font="Regular;22" />\n\t\t\t\t         <ePixmap position="15,400" size="550,5" pixmap="~/images/slider.png" alphaTest="blend" transparent="1" backgroundColor="transparent"/>\n                                        <ePixmap alphaTest="on" name="more" pixmap="~/buttons/more.png" position="250,405" size="120,50" transparent="1" zPosition="4"/>\n                                </screen>' % self.feed.getName()
        Screen.__init__(self, session)
        self.skin_path = resolveFilename(SCOPE_PLUGINS, "Extensions/PurePrestige")
    ...
    def openmore(self):
        if self.url:
            if self.item['title']:
                self.session.open(PurePrestigeFeedScreenMore, self.url, self.item['title'])
