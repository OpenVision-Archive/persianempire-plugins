...
class PurePrestigeFilesScreen(Screen):
    skin = '\n                        <screen name="PurePrestigeFilesScreen" position="center,center" size="640,520" title="Screenshot Files"  flags="wfNoBorder" >\n                        <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/PurePrestige/images/framesd.png" position="0,0" size="640,520"/>\t\t\n\t\n\t\t\t<ePixmap position="15,65" size="610,5" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/PurePrestige/images/slider.png" alphatest="blend" transparent="1" backgroundColor="transparent"/>\n\t\t\n                          <widget name="ButtonBluetext" position="75,25" size="160,40" valign="center" halign="left" zPosition="10" font="Regular;22" transparent="1" />\n\t\t\t  <widget name="ButtonBlue" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/PurePrestige/images/button_blue.png" position="55,35" zPosition="10" size="100,100" transparent="1" alphatest="on" />\n                          <widget name="ButtonYellowtext" position="285,25" size="200,40" valign="center" halign="left" zPosition="10" font="Regular;22" transparent="1" />\n\t\t\t  <widget name="ButtonYellow" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/PurePrestige/images/button_yellow.png" position="265,35" zPosition="10" size="100,100" transparent="1" alphatest="on" />\n                          <widget name="info" position="25,415" zPosition="4" size="400,30" font="Regular;20" foregroundColor="yellow" transparent="1" halign="left" valign="center" />\n                          <widget name="menu" position="30,75" size="580,425" scrollbarMode="showOnDemand" transparent="1" zPosition="2" />\n\t                  \n        \t</screen>\n\t\t'
...
class PurePrestigeScreenGrabberSetup(Screen, ConfigListScreen):
    skin = '\n                        <screen name="PurePrestigeScreenGrabberSetup" position="center,center" size="640,520" title="ScreebGrabber setup"  flags="wfNoBorder" >\n                        <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/PurePrestige/images/framesd.png" position="0,0" size="640,520"/>\t\t\n\t\t \n\t\t\t<ePixmap position="15,45" size="610,5" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/PurePrestige/images/slider.png" alphatest="blend" transparent="1" backgroundColor="transparent"/>\n\t\t\t<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/PurePrestige/images/button_red.png" position="20,15" zPosition="0" size="140,40" transparent="1" alphatest="on" />\n\t\t\t<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/PurePrestige/images/button_green.png" position="160,15" zPosition="0" size="140,40" transparent="1" alphatest="on" />\n\t\t\t<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/PurePrestige/images/button_yellow.png" position="300,15" zPosition="0" size="140,40" transparent="1" alphatest="on" />\n\t\t\t\n\t\t\t<widget render="Label" source="key_red" position="40,5" size="140,40" zPosition="5" valign="center" halign="left" backgroundColor="red" font="Regular;21" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />\n\t\t\t<widget render="Label" source="key_green" position="180,5" size="140,40" zPosition="5" valign="center" halign="left" backgroundColor="red" font="Regular;21" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />\n\t\t\t<widget render="Label" source="key_yellow" position="320,5" size="140,40" zPosition="5" valign="center" halign="left" backgroundColor="red" font="Regular;21" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />\n                        <widget name="config" position="20,50" size="600,320" scrollbarMode="showOnDemand" transparent="1" zPosition="2" />\n\t\t        <widget name="info" position="0,370" zPosition="4" size="580,30" font="Regular;20" foregroundColor="yellow" transparent="1" halign="center" valign="center" />\n                </screen>'
...
class PurePrestigeScreenGrabberView(Screen):
    ...
    def __init__(self, session):
        ...
        PreviewString = PreviewString + ' <eLabel font="Regular;18" backgroundColor="#00640808" halign="left" valign="center" position="10,80" size="300,25" text="Please wait....." zPosition="1"/>\n'
        PreviewString = PreviewString + ' <eLabel font="Regular;18" backgroundColor="#00080808" halign="left" valign="center" position="10,50" size="620,25" text="OK=Save        Exit=Play TV        Green=Setup        Yellow=Files" zPosition="9"/>\n'
