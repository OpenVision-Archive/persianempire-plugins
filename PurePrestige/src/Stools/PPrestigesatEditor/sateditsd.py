...
class SatelliteImport(Screen):
    ...
    modeSelect = 1
    modeUnSelect = 2
    skin = '\n\t\t<screen position="center,center" size="560,450" title="lyngsat satellites" >\n\n\t\t<widget name="list" position="0,20" size="560,290" scrollbarMode="showOnDemand" />\n\t\t<widget name="head" position="0,40" size="560,24" scrollbarMode="showNever" />\n\t\t<widget name="fspace" position="0,320" zPosition="4" size="560,130" font="Regular;24" foregroundColor="#ffffff" transparent="1" halign="center" valign="center" />\n                </screen>'
...
class TransponderList(MenuList):
    ...
    def setEntries(self, transponderlist):
        ...
        for x in transponderlist:
            ...
            tp.append(MultiContentEntryText(pos=(calc_xpos(tp), 0), size=(30, self.rowHight), font=0, flags=RT_HALIGN_CENTER | RT_VALIGN_TOP, text=transponder.inversion, color=color, border_width=1, border_color=806544))
            tp.append(MultiContentEntryText(pos=(calc_xpos(tp), 0), size=(30, self.rowHight), font=0, flags=RT_HALIGN_CENTER | RT_VALIGN_TOP, text=transponder.pilot, color=color, border_width=1, border_color=806544))
            tp.append(MultiContentEntryText(pos=(calc_xpos(tp), 0), size=(60, self.rowHight), font=0, flags=RT_HALIGN_CENTER | RT_VALIGN_TOP, text=transponder.tsid, color=color, border_width=1, border_color=806544))
            tp.append(MultiContentEntryText(pos=(calc_xpos(tp), 0), size=(60, self.rowHight), font=0, flags=RT_HALIGN_CENTER | RT_VALIGN_TOP, text=transponder.onid, color=color, border_width=1, border_color=806544))
            res.append(tp)
...
class TransponderEditor(Screen, ConfigListScreen, Transponder):
    skin = '\n\t\t<screen position="center,center" size="560,430" title="Edit" >\n\t\t<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/PurePrestige/ddbuttons/red.png" position="0,0" size="140,40" alphatest="on" />\n\t\t<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/PurePrestige/ddbuttons/green.png" position="140,0" size="140,40" alphatest="on" />\n\t\t<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/PurePrestige/ddbuttons/yellow.png" position="280,0" size="140,40" alphatest="on" />\n\t\t<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/PurePrestige/ddbuttons/blue.png" position="420,0" size="140,40" alphatest="on" />\n\t\t<widget name="key_red" position="0,0" zPosition="1" size="140,40" font="Regular;20" halign="center" valign="center" backgroundColor="#9f1313" transparent="1" />\n\t\t<widget name="key_green" position="140,0" zPosition="1" size="140,40" font="Regular;20" halign="center" valign="center" backgroundColor="#1f771f" transparent="1" />\n\t\t<widget name="key_yellow" position="280,0" zPosition="1" size="140,40" font="Regular;20" halign="center" valign="center" backgroundColor="#a08500" transparent="1" />\n\t\t<widget name="key_blue" position="420,0" zPosition="1" size="140,40" font="Regular;20" halign="center" valign="center" backgroundColor="#18188b" transparent="1" />\n\t\t<widget name="config" position="10,50" size="540,325" scrollbarMode="showOnDemand" />\n\t\t</screen>'
...
class SatelliteList(MenuList):
    ...
    def setEntries(self, satelliteslist):
        ...
        for x in satelliteslist:
            ...
            satentry.append(MultiContentEntryText(pos=(430, 0), size=(103, 24), font=0, flags=RT_HALIGN_RIGHT | RT_VALIGN_TOP, text=posStr, color=color, color_sel=color_sel, backcolor=backcolor, backcolor_sel=backcolor_sel, border_width=1, border_color=15792383))
            res.append(satentry)
...
class Head(HTMLComponent, GUIComponent):
    ...
    def setEntries(self, data = None):
        ...
        if data is not None:
            for x in data:
                res.append(MultiContentEntryText(pos=(x[0], 0), size=(x[1], 24), font=0, flags=RT_HALIGN_CENTER | RT_VALIGN_TOP, text=x[2], color=12632256, backcolor=625428280, color_sel=16777215, backcolor_sel=627073024, border_width=1, border_color=806544))
...
class MenuSelection(Screen):
    skin = '\n\t\t<screen position="center,center" size="400,300" title="update satellites">\n\t\t\t<widget name="menulist" position="20,10" size="360,280" />\n\t\t</screen>'
...
class PrestigePanelSatellitesEditor(Screen):
    ...
    def __init__(self, session):
        ...
        self['key_red'] = Button(_('remove'))
        self['key_green'] = Button(_('edit'))
        self['key_yellow'] = Button(_('Update-add'))
        self['key_blue'] = Button(_('sort'))
        self['infolist'] = MenuList([])
        self['infolist'].l = eListboxPythonMultiContent()
        self['infolist'].l.setSelectionClip(eRect(0, 0, 0, 0))
