...
class PrestigePanelTransponderEditor(Screen, ConfigListScreen, Transponder):
    skin = '\n                <screen name="PrestigePanelTransponderEditor" position="center,center" size="640,520" title="Edit"  flags="wfNoBorder" >\n                <ePixmap pixmap="~/images/framesd.png" position="0,0" size="640,520"/>\t\t\n\t\t<ePixmap pixmap="~/ddbuttons/red.png" position="25,25" size="140,40" alphaTest="on" />\n\t\t<ePixmap pixmap="~/ddbuttons/green.png" position="165,25" size="140,40" alphaTest="on" />\n\t\t<ePixmap pixmap="~/ddbuttons/yellow.png" position="305,25" size="140,40" alphaTest="on" />\n\t\t<ePixmap pixmap="~/ddbuttons/blue.png" position="445,25" size="140,40" alphaTest="on" />\n\t\t<widget name="key_red" position="25,25" zPosition="1" size="140,40" font="Regular;20" horizontalAlignment="center" verticalAlignment="center" backgroundColor="#9f1313" transparent="1" />\n\t\t<widget name="key_green" position="165,25" zPosition="1" size="140,40" font="Regular;20" horizontalAlignment="center" verticalAlignment="center" backgroundColor="#1f771f" transparent="1" />\n\t\t<widget name="key_yellow" position="305,25" zPosition="1" size="140,40" font="Regular;20" horizontalAlignment="center" verticalAlignment="center" backgroundColor="#a08500" transparent="1" />\n\t\t<widget name="key_blue" position="445,25" zPosition="1" size="140,40" font="Regular;20" horizontalAlignment="center" verticalAlignment="center" backgroundColor="#18188b" transparent="1" />\n\t\t<widget name="config" position="25,75" size="590,340" scrollbarMode="showOnDemand" transparent="1" zPosition="2" />\n\t\t</screen>'
...
class PrestigePanelTranspondersEditor(Screen):
    ...
    if HD_Res == True:
        skin = '\n                <screen name="PrestigePanelSatellitesEditor" position="center,center" size="920,600" title=""  flags="wfNoBorder" >\n                <ePixmap pixmap="~/images/frame.png" position="0,0" size="920,600" transparent="1"/>\t\n\n\t\t<ePixmap pixmap="~/ddbuttons/red.png" position="30,25" size="140,50" alphaTest="on" />\n\t\t<ePixmap pixmap="~/ddbuttons/green.png" position="170,25" size="140,50" alphaTest="on" />\n\t\t<ePixmap pixmap="~/ddbuttons/yellow.png" position="310,25" size="140,50" alphaTest="on" />\n\t\t<ePixmap pixmap="~/ddbuttons/blue.png" position="450,25" size="140,50" alphaTest="on" />\n\t\t\n\t\t<widget name="key_red" position="30,25" zPosition="1" size="140,40" font="Regular;20" horizontalAlignment="center" verticalAlignment="center" backgroundColor="#9f1313" transparent="1" />\n\t\t<widget name="key_green" position="170,25" zPosition="1" size="140,40" font="Regular;20" horizontalAlignment="center" verticalAlignment="center" backgroundColor="#1f771f" transparent="1" />\n\t\t<widget name="key_yellow" position="310,25" zPosition="1" size="140,40" font="Regular;20" horizontalAlignment="center" verticalAlignment="center" backgroundColor="#a08500" transparent="1" />\n\t\t<widget name="key_blue" position="450,25" zPosition="1" size="140,40" font="Regular;20" horizontalAlignment="center" verticalAlignment="center" backgroundColor="#18188b" transparent="1" />\n\t\t<widget name="list" position="20,89" size="880,456" scrollbarMode="showOnDemand" transparent="1" zPosition="2" />\n\t\t<widget name="head" position="20,65" size="880,24" scrollbarMode="showNever" transparent="1" zPosition="2" />\n\t\t</screen>'
    else:
