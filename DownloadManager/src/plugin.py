...
class Ipkremove2(Screen):
    skin = """
		<screen position="center,center" size="800,500" title="Installed Packages List" >
			...
			<widget name="info" position="100,230" zPosition="4" size="100,25" font="Regular;18" foregroundColor="#ffffff" transparent="1" horizontalAlignment="center" verticalAlignment="center" /-->
		</screen>"""
...
class Downloads(Screen):
    skin = '\n\t\t<screen position="center,center" size="520,400" title="Open Vision - https://openvision.tech" >\n\t\t\t<!--widget name="text" position="0,0" size="550,25" font="Regular;20" /-->\n\t\t\t<widget name="list" position="10,40" size="500,350" scrollbarMode="showOnDemand" />\n\t\t\t<!--widget name="pixmap" position="200,0" size="190,250" /-->\n\t\t\t<!--eLabel position="70,100" zPosition="-1" size="100,69" backgroundColor="#222222" /-->\n\t\t\t<widget name="info" position="80,80" zPosition="4" size="350,300" font="Regular;18" foregroundColor="#ffffff" transparent="1" horizontalAlignment="left" verticalAlignment="center" />\n\t\t<ePixmap name="red"    position="20,380"   zPosition="2" size="140,40" pixmap="buttons/red.png" transparent="1" alphaTest="on" />\n\t\t<widget name="key_red" position="20,380" size="140,40" verticalAlignment="center" horizontalAlignment="center" zPosition="4"  foregroundColor="#ffffff" font="Regular;20" transparent="1" shadowColor="#25062748" shadowOffset="-2,-2" />\n\t\t<ePixmap name="yellow"    position="180,380"   zPosition="2" size="140,40" pixmap="buttons/yellow.png" transparent="1" alphaTest="on" />\n\t\t<widget name="key_yellow" position="180,380" size="140,40" verticalAlignment="center" horizontalAlignment="center" zPosition="4"  foregroundColor="#ffffff" font="Regular;20" transparent="1" shadowColor="#25062748" shadowOffset="-2,-2" />\n\t\t</screen>'
...
class Getipk(Screen):
    skin = '\n\t\t<screen position="center,center" size="800,500" title="Open Vision - https://openvision.tech" >\n\t\t\t<!--widget name="text" position="0,0" size="550,25" font="Regular;20" /-->\n\t\t\t<widget name="list" position="10,20" size="750,350" scrollbarMode="showOnDemand" />\n\t\t\t<!--widget name="pixmap" position="200,0" size="190,250" /-->\n\t\t\t<eLabel position="70,100" zPosition="-1" size="100,69" backgroundColor="#222222" />\n\t\t\t<widget name="info" position="50,50" zPosition="4" size="500,400" font="Regular;22" foregroundColor="#ffffff" transparent="1" horizontalAlignment="left" verticalAlignment="top" />\n\t\t        <ePixmap name="red"    position="0,450"   zPosition="2" size="140,40" pixmap="buttons/red.png" transparent="1" alphaTest="on" />\n\t                <ePixmap name="green"  position="140,450" zPosition="2" size="140,40" pixmap="buttons/green.png" transparent="1" alphaTest="on" />\n\t                <!--ePixmap name="yellow" position="280,450" zPosition="2" size="140,40" pixmap="buttons/yellow.png" transparent="1" alphaTest="on" /> \n\t                <ePixmap name="blue"   position="420,450" zPosition="2" size="140,40" pixmap="buttons/blue.png" transparent="1" alphaTest="on" /--> \n\n\t                <widget name="key_red" position="0,450" size="140,40" verticalAlignment="center" horizontalAlignment="center" zPosition="4"  foregroundColor="#ffffff" font="Regular;20" transparent="1" shadowColor="#25062748" shadowOffset="-2,-2" /> \n\t                <widget name="key_green" position="140,450" size="140,40" verticalAlignment="center" horizontalAlignment="center" zPosition="4"  foregroundColor="#ffffff" font="Regular;20" transparent="1" shadowColor="#25062748" shadowOffset="-2,-2" /> \n\t                <widget name="key_yellow" position="280,450" size="140,40" verticalAlignment="center" horizontalAlignment="center" zPosition="4"  foregroundColor="#ffffff" font="Regular;20" transparent="1" shadowColor="#25062748" shadowOffset="-2,-2" />\n\t                <!--widget name="key_blue" position="420,450" size="140,50" verticalAlignment="center" horizontalAlignment="center" zPosition="4"  foregroundColor="#ffffff" font="Regular;20" transparent="1" shadowColor="#25062748" shadowOffset="-2,-2" /-->\n                </screen>'
