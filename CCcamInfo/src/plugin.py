...
config.plugins.CCcamInfo.ecmInfoEnabled = ConfigYesNo(default=False)
...
config.plugins.CCcamInfo.blacklist = ConfigText(default="/media/hdd/CCcamInfo.blacklisted", fixed_size=False)
