...
class PEInfoTexto(Screen):
    skin = '\n\t<screen position="center,center" size="1050,602" title="%s">\n\n\t<widget name="lista" position="0,0" size="250,602" scrollbarMode="showOnDemand" zPosition="12" transparent="1" />\n\t<widget name="textoinfo" position="288,37" size="745,522" verticalAlignment="top" horizontalAlignment="left" text="%s" font="Regular; 18" zPosition="1" />\n\t<widget name="listainfo" position="288,37" size="745,522" zPosition="1" scrollbarMode="showOnDemand" transparent="1"/>\n\t<widget name="listaproc" position="288,37" size="745,522" zPosition="1" scrollbarMode="showOnDemand" transparent="1"/>\n\n\t<widget name="key_pup" position="295,568" size="220,25" verticalAlignment="center" horizontalAlignment="left" zPosition="4" font="Regular;17" transparent="1" /> \n\t<widget name="img_pup" position="260,567" zPosition="2" size="35,25" pixmap="~/icons/pup.png" transparent="1" alphaTest="on" />\n\n\t<widget name="key_pdown" position="435,568" size="220,25" verticalAlignment="center" horizontalAlignment="left" zPosition="4" font="Regular;17" transparent="1" /> \n\t<widget name="img_pdown" position="400,567" zPosition="2" size="35,25" pixmap="~/icons/pdown.png" transparent="1" alphaTest="on" />\t\n\t\n\t<widget name="key_red" position="548,567" size="120,40" verticalAlignment="center" horizontalAlignment="center" backgroundColor="#000000" foregroundColor="#ffffff" zPosition="4" font="Regular;17" transparent="1" /> \n\t<widget name="key_green" position="674,567" size="120,40" verticalAlignment="center" horizontalAlignment="center" backgroundColor="#000000" foregroundColor="#ffffff" zPosition="4" font="Regular;17" transparent="1" />  \n\t<widget name="key_yellow" position="801,567" size="120,40" verticalAlignment="center" horizontalAlignment="center" backgroundColor="#000000" foregroundColor="#ffffff" zPosition="4" font="Regular;17" transparent="1" /> \n\t<widget name="key_blue" position="928,567" size="120,40" verticalAlignment="center" horizontalAlignment="center" backgroundColor="#000000" foregroundColor="#ffffff" zPosition="4" font="Regular;17" transparent="1" /> \n\n\t\n\t<widget name="img_red" position="548,572" zPosition="2" size="130,40" pixmap="~/icons/red.png" transparent="1" alphaTest="on" />\n\t<widget name="img_green" position="674,572" zPosition="2" size="130,40" pixmap="~/icons/green.png" transparent="1" alphaTest="on" />\n\t\n\t<widget name="img_yellow" position="801,572" zPosition="2" size="130,40" pixmap="~/icons/yellow.png" transparent="1" alphaTest="on" />\n\t<widget name="img_blue" position="928,572" zPosition="2" size="130,40" pixmap="~/icons/blue.png" transparent="1" alphaTest="on" />\n\t<widget name="titulo" position="288,0" size="746,28" text=" " transparent="1" horizontalAlignment="center" font="Regular; 22" zPosition="1" />\n\t<ePixmap name="fondo" position="0, 0" size="1050, 602" pixmap="~/icons/peinfo.png" transparent="1" alphaTest="blend"/>\n\t\t\t\n\t</screen>' % (_('PE') + ' ' + 'Information', _('Please Wait'))
